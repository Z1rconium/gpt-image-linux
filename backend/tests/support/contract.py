...
def _configure_runtime(tmp_path: Path, *, access_key: str = "", allow_unauthenticated: bool = True):
    ...
    config.ADMIN_MAX_FAILURES = 5
    config.ADMIN_LOCKOUT_SECONDS = 300
    config.IP_ALLOWLIST = ""
    ...
    config.WEBHOOK_MAX_CONCURRENCY = 4
    config.WEBHOOK_QUEUE_MAX_SIZE = 100
    config.MAX_FILE_SIZE_MB = 50
    config.EDIT_UPLOAD_MAX_MB = 200
    config.UPLOAD_INFLIGHT_MAX_MB = 512
    config.UPLOAD_INFLIGHT_PER_IP_MAX_MB = 256
    ...
    config.IMPORT_UPLOAD_RESERVATION_TTL_SECONDS = 1800
    config.IMPORT_UPLOADS_PER_IP_PER_MINUTE = 3
