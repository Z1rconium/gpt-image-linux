...
OVERALL_CONFIG_REGISTRY: tuple[OverallConfigSpec, ...] = (
    ...
    _spec("AI_ASSISTANT_IMAGE_DECODE_MAX_MB", "int", "128", "AI Assistant", "Max estimated resident memory for one assistant image decode.", min_value=16),
    ...
    _spec("MAX_IMAGE_PIXELS", "int", "25000000", "Limits", "Max decoded image pixels.", min_value=1),
