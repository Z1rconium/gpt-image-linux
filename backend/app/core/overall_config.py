...
OVERALL_CONFIG_REGISTRY: tuple[OverallConfigSpec, ...] = (
    ...
    _spec("CSRF_ORIGIN_CHECK_ENABLED", "bool", "true", "Access / Security", "Reject cross-origin unsafe requests."),
    _spec("UPSTREAM_HOST_ALLOWLIST", "string", "", "Access / Security", "Upstream API host allowlist.", validator="host_list"),
