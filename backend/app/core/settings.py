...
ADMIN_MAX_FAILURES = max(1, int(os.getenv("ADMIN_MAX_FAILURES", "5")))
ADMIN_LOCKOUT_SECONDS = max(1, int(os.getenv("ADMIN_LOCKOUT_SECONDS", "300")))
...
WEBHOOK_MAX_CONCURRENCY = max(1, int(os.getenv("WEBHOOK_MAX_CONCURRENCY", "4")))
WEBHOOK_QUEUE_MAX_SIZE = max(1, int(os.getenv("WEBHOOK_QUEUE_MAX_SIZE", "100")))
MAX_FILE_SIZE_MB = int(os.getenv("MAX_FILE_SIZE_MB", "50"))
EDIT_UPLOAD_MAX_MB = max(1, int(os.getenv("EDIT_UPLOAD_MAX_MB", "200")))
UPLOAD_INFLIGHT_MAX_MB = max(1, int(os.getenv("UPLOAD_INFLIGHT_MAX_MB", "512")))
UPLOAD_INFLIGHT_PER_IP_MAX_MB = max(
    1,
    int(os.getenv("UPLOAD_INFLIGHT_PER_IP_MAX_MB", "256")),
)
UPLOAD_RESERVATION_TTL_SECONDS = max(
    60,
    int(os.getenv("UPLOAD_RESERVATION_TTL_SECONDS", "1800")),
)
...
IMPORT_ARCHIVE_MAX_MB = int(os.getenv("IMPORT_ARCHIVE_MAX_MB", "256"))
