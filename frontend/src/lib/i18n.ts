...
const en = {
  ...
  imagePrompt: {
    ...
    fileHint: 'Supported raster images · up to 50 MB · pixel limits apply',
    replace: 'Replace image',
    remove: 'Remove image',
    formatError: 'The image format is unsupported or the file could not be decoded.',
    fileTooLarge: 'The image is too large. Maximum upload size is 50 MB.',
  ...
  jobs: {
    ...
    noErrorHistoryHint: 'Jobs with error or upstream error statuses will show here.',
...
const zh: TranslationSchema<typeof en> = {
  ...
  imagePrompt: {
    ...
    fileHint: '支持安全位图格式 · 最大 50 MB · 受像素限制保护',
    replace: '替换图片',
    remove: '移除图片',
    formatError: '图片格式不受支持，或文件无法解码。',
    fileTooLarge: '图片过大，上传上限为 50 MB。',
  ...
  jobs: {
    ...
    noErrorHistoryHint: '状态为 error 或 upstream_error 的任务会显示在这里。',
