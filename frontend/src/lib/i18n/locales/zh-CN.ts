...
const zh: Translation = {
  ...
  settings: {
    ...
    apiKey: 'API 密钥',
    apiKeyHint: '请填写启动时在 SECRET_REGISTRY_JSON 中声明的 secret_id；此处不接受环境变量引用或明文密钥。',
    upstreamSocks5Proxy: 'SOCKS5 代理',
    upstreamSocks5ProxyHint: '可选。请填写 SECRET_REGISTRY_JSON 中值为 socks5:// 地址的 secret_id；仅生成/编辑的上游 API 请求会使用。',
    webhookUrl: 'Webhook URL',
    webhookUrlHint: '可选的全局 HTTPS 回调，用于生成/编辑任务完成后通知；请填写 SECRET_REGISTRY_JSON 中的 secret_id，并配置 WEBHOOK_SIGNING_SECRET。',
    r2Backup: 'R2 备份',
    ...
    r2SecretHint: '请填写 SECRET_REGISTRY_JSON 中绑定该 R2 endpoint 的 secret_id；此处不接受明文凭据。',
    r2HealthCheck: '测试 R2',
    ...
    nodeImageApiKeyHint: '请填写启动时在 SECRET_REGISTRY_JSON 中声明的 secret_id；此处不接受明文密钥。',
