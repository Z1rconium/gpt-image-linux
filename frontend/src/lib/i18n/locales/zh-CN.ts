...
const zh: Translation = {
  ...
  gallery: {
    ...
    nodeImageUploadPreparing: (count) => `正在上传 ${count} 张图片，请保持页面打开。`,
    nodeImageResultTitle: 'NodeImage 上传结果',
    nodeImageResultSummary: (uploaded, failed) => `成功上传 ${uploaded} 张${failed ? `，失败 ${failed} 张` : ''}。GPT Image Panel 不会保存这些链接。`,
