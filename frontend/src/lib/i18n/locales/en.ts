const en = {
  ...
  settings: {
    ...
    apiKey: 'API key',
    apiKeyHint: 'Enter a secret_id declared in SECRET_REGISTRY_JSON at startup. Environment-variable references and literal keys are not accepted here.',
    upstreamSocks5Proxy: 'SOCKS5 proxy',
    upstreamSocks5ProxyHint: 'Optional. Enter a SECRET_REGISTRY_JSON secret_id whose value is a socks5:// URL. Only generation/edit upstream API calls use it.',
    webhookUrl: 'Webhook URL',
    webhookUrlHint: 'Optional global HTTPS callback for completed generation/edit jobs. Enter a SECRET_REGISTRY_JSON secret_id; requires WEBHOOK_SIGNING_SECRET.',
    r2Backup: 'R2 Backup',
    ...
    r2SecretHint: 'Enter a SECRET_REGISTRY_JSON secret_id bound to this R2 endpoint. Literal credentials are not accepted here.',
    ...
    nodeImageApiKeyHint: 'Enter a secret_id declared in SECRET_REGISTRY_JSON at startup. Literal keys are not accepted here.',
